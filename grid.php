            ...
            <div class="penampung-konten">
                ...
                <div class="content">
                    <div class="view-as">
                        ...
                        <?php
                        if (isset($serial)) {
                            echo "<a href='grid.php?txtcari=$cari&serial=$serial' id='active' class='btngrid'><i class='fas fa-th fa-lg'></i></a>";
                            echo "<a href='list.php?txtcari=$cari&serial=$serial' class='btnlist'><i class='fas fa-list fa-lg'></i></a>";
                        } else {
                            echo "<a href='grid.php?txtcari=$cari'  id='active' class='btngrid'><i class='fas fa-th fa-lg'></i></a>";
                            echo "<a href='list.php?txtcari=$cari' class='btnlist'><i class='fas fa-list fa-lg'></i></a>";
                        }
                        ?>
                    ...
                    <div class="grid-content">
                        ...
                        <div class="grid-view">
                            ...
                            if (isset($_GET['serial'])) {
                                ...
                                $sql = "SELECT * FROM movie where judul LIKE ? AND serial=?";
                                $stmt = $mysqli->prepare($sql);
                                $stmt->bind_param("ss", $keyword, $serial);
                            } else {
                            ...
                            if (isset($_GET['serial'])) {
                                $serial = $_GET['serial'];
                                $sql = "SELECT * FROM movie where judul LIKE ? AND serial=? LIMIT ?, ?";
                                $stmt = $mysqli->prepare($sql);
                ...
                <div class=" pagination">
                    <p>
                        ...
                        // } else if ($cari=="" && !isset($_GET['serial'])) {
